...
for xd in range(10000):
 ...
 b=random.choice(['7','8.1.0','9','10','11','12'])
 c=random.choice(['Infinix X608B','Infinix X670','Infinix X695C','Infinix X612','Infinix X572','M2102K1G','M2010J19CG','M2007J20CG','M2012K11AG'])
 d=random.choice(['AppleWebKit/537.36 (KHTML, like Gecko) Chrome/','AppleWebKit/537.36 (KHTML, like Gecko) Version 4.0 Chrome/'])
 e=random.randrange(100,105)
 f='0'
 g='0'
 h='0'
 i=random.choice(['Mobile Safari/537.36','Safari/537.36','Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/385.0.0.32.114;]'])
